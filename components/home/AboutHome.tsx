			...
			<Box pt={{ base: 60, md: 80, lg: 100 }} pb={{ base: 30, md: 40, lg: 60 }}>
				<Grid mt={24} gutter={{ base: 24, md: 64 }} align="center">
					<Grid.Col span={{ base: 12, md: 6 }}>
						<TitleRender order={2} pb={16} tt="capitalize">
							Chúng tôi là AIA
						</TitleRender>
						<Text pb={16}>
							Được thành lập vào năm 2008, BraveBits là một trong số ít những
							doanh nghiệp Việt Nam đầu tiên thành công trong việc phát triển
							những phần mềm mã nguồn mở, phục vụ hàng trăm ngàn khách hàng trên
							khắp thế giới. Chúng tôi tự hào có được một đội ngũ trẻ, chuyên
							nghiệp và chuyên sâu về lĩnh vực lập trình, thiết kế và marketing.
						</Text>
						<Text pb={16}>
