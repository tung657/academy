...
export const dataResearches = [
	...
	},
	{
		...
		contents: [
			...
			` HNghiên cứu phát triển công cụ tự động tóm tắt các ý chính của một văn bản tiếng Việt thành một đoạn tin ngắn và nghiên cứu phát triển công cụ tự động tổng hợp các ý chính từ nhiều văn bản tiếng Việt cùng chủ đề thành một văn bản duy nhất.`,
		],
	},
	{
		type: 1,
